                        ...
                        <div class="tab-content">
                            <div id="pane1" class="tab-pane active">
                                <div class="row ">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <input type="hidden" id="depart_pick_pos"
                                                                name="depart_pick_pos"/>
                                            <input type="hidden"
                                                                                                id="depart_drop_pos"
                                            ...
                                            <div class="col-md-6 col pick-group padding_top">
                                                <div class="input-group append_pick_address_here"><span
                                                    ...
                                                    <select name="data[pick_address_raw]" id="data_pick_address_raw"
                                                            ...
                                                            style="display: none;"
                                                            placeholder="Điểm đ&oacute;n, sân bay hoặc khách sạn"></select><span
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-7 padding_top ">
                                                <div class="input-group"><span style="display: block;"
                                                                               class="input-group-addon"><i
                                                                class="fa fa-calendar"></i></span> <input
                                                            style="outline: none; position: static;" name="depart_time"
                                                            id="data_depart_time" class="form-control  datepicker"
                                                            required="" type="text" placeholder="Thời gian đón"/></div>
                                            </div>
